...
export const deleteChannel = async(channel_id: number) => {
    const response = await axios.delete(`${baseURL}/protected/channel/${channel_id}`, {
        headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${localStorage.getItem("token")}`,
        },
...
export const addUserToChannel = async(channel_id: number, user_id: string) => {
    const response = await axios.put(`${baseURL}/protected/channel/${channel_id}/user/${user_id}`, {
        user_id,
        channel_id,
    }, {
        headers: {
...
export const banUser = async(channel_id: number, user_id: string) => {
    const response = await axios.delete(`${baseURL}/protected/channel/${channel_id}/user/${user_id}`,  {
        headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${localStorage.getItem("token")}`,
        },
...
export const updateChannel = async(channel_id: number, name: string, img: string) => {
    const response = await axios.post(`${baseURL}/protected/channel/${channel_id}/update_metadata`, {
        name,
        img,
    }, {
        headers: {
