...
const channelName = ref(props.isUpdating? channelStore.selectedChannel.name : "");
const channelImage = ref(props.isUpdating? channelStore.selectedChannel.img : "");
const channelColors = ref(props.isUpdating? channelStore.selectedChannel.theme : themes[0]);
...
<template>
        <div class="createChannel">
            ...
            />
            <div class="buttons">
                <button class="delete" v-if="isUpdating">Supprimer</button>
